...
#                                                                                                                      #
# data used: 'suni_data_preproc_aug0_split.csv', preprocessed data without augmentation                                #
# based on Datensatz_AF_FK_Sunitinib_final.csv: dataset for every split with set column to be split on                 #
########################################################################################################################
...
def train_test_split(split="1", data_augmentation="0", feature_selection=False,
    ...
    # csv_filename = f'suni_data_split{split}_aug{data_augmentation}_preproc.csv' # data with simulated patients
    ...
    if feature_selection:
        ...
        selected_features_csv = f"suni_selected_features_{algorithm_name}_{split}_{data_augmentation}.csv"
