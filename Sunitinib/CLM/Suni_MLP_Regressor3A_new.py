...
def run_mlp_two_hidden_layers_experiment(split, data_augmentation, feature_selection, algorithm_name,
                                         best_params,
                                         num_epochs):
    X_train, y_train, X_test, y_test = Data_loadA2_suni.train_test_split(
        split=split,
...
def run_mlp_one_hidden_layer_experiment(split, data_augmentation, feature_selection, algorithm_name,
                                        best_params,
                                        num_epochs):
    X_train, y_train, X_test, y_test = Data_loadA2_suni.train_test_split(
        split=split,
